...
namespace Balanca3
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    //Mostra uma Mensagem
                    MessageBox.Show("Nenhuma porta COM conectada", "Ocorreu um Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    this.Close();
            ...
            try
            {
                ...
                if (serialPort1.IsOpen)
                {
                    ...
                    else
                    {
                        ...
                        //Mostra uma Mensagem
                        MessageBox.Show("Nenhum Dado Recebido Tente outra Porta", "Ocorreu um Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btnPararR_Click(object sender, EventArgs e)
        {
            //O Botão Parar fica Habilitado
            btnParar.Enabled = true;
